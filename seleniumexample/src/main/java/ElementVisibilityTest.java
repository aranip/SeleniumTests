...
public class ElementVisibilityTest {
    ...
    public static void main(String[] args) {
        ...
        boolean b1 = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/form/div[6]/button")).isDisplayed(); //for submit button
        ...
        boolean b3 = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/form/div[6]/button")).isEnabled();
